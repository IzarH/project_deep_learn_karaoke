...
loaded_tensor = torch.load("project_B/open-unmix-main/scripts/Y_700.pt")
print("Loaded true Tensor:")
print(loaded_tensor)

loaded_tensor_mine = torch.load("project_B/open-unmix-main/scripts/Y_hat_700.pt")
...
print(diff_tensor[1,1,37,36])
print(loaded_tensor[1,1,37,36])
print(loaded_tensor_mine[1,1,37,36])